...
const Slide = ({ video, text, des }) => {
  return (
    <div className="w-full mt-24 grid grid-cols-5 border bg-center object-cover bg-cover h-[28rem] text-stone-900 ">
      <div className="col-span-2 bg-[#FEBF00]">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-16 h-16 dark:text-violet-600">
		...
		<p className="px-6 py-2 text-lg font-semibold text-center sm:font-bold sm:text-xl md:text-2xl lg:max-w-2xl xl:max-w-4xl dark:text-gray-700">"Veniam quidem animi ea maxime odit fugiat architecto perferendis ipsum perspiciatis iusto, provident qui nam dolorum corporis."</p>
